...
@section('content')
    ...
    <form action="{{ route('columnTranslations.update', $columnTranslation->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="row mt-2">  
            <div class="col-12 action">
                ...
                <form action="{{ route('columnTranslations.destroy',$columnTranslation->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
